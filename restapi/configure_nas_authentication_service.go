...
import (
	...
	"nas-authenticator/restapi/operations"
)

//go:generate swagger generate server --target ../../nas-authenticator --name NasAuthenticationService --spec ../swagger.yml --principal interface{} --exclude-main

func configureFlags(api *operations.NasAuthenticationServiceAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.NasAuthenticationServiceAPI) http.Handler {
